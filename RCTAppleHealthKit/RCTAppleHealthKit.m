...
RCT_EXPORT_METHOD(getTimeInDaylightSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self getTimeInDaylightSamples:input callback:callback];
}
...
RCT_EXPORT_METHOD(getFlightSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
  [self activity_getFlightSamples:input callback:callback];
}

RCT_EXPORT_METHOD(getStandTimeDailySamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
   [self activity_getStandTimeDailySamples:input callback:callback];
}
...
RCT_EXPORT_METHOD(getStandTimeSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
  [self activity_getStandTimeSamples:input callback:callback];
}
...
RCT_EXPORT_METHOD(saveEnvironmentalAudioExposureSamples:(NSArray<NSDictionary *> *)samples callback:(RCTResponseSenderBlock)callback)
{
    [self saveEnvironmentalAudioExposureSamples:samples callback:callback];
}
